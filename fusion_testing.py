...
def main():
    ...
    models = ["agingregin18ie", "agingregin18oe"]
    score_all = {}
    for model_name in models:
        ...
        if "ie" in model_name:
            ...
            score_all["ie"] = t.score_list
        else:
            dp = "./data/test/agingreginOE"
            t = Test()
            t.run(model_name, dp, net_num)
            score_all["oe"] = t.score_list
    print(len(score_all["ie"]))
    print(score_all["ie"][0])
